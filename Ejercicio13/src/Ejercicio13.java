...
public class Ejercicio13 {
	public static void main(String[] args) {
		String dirName = "resultados";
		String fileName = "tarea13.txt";
		Ciudad ciudad = new Ciudad();
		
		Thread hilo1 = new Thread(new TareaInput("Input", ciudad));
		Thread hilo2 = new Thread(new TareaFile("File", dirName, fileName));
		Thread hilo3 = new Thread(new TareaOutput("Output", dirName + "\\" + fileName, ciudad));
		System.out.println();
...
class TareaFile implements Runnable {
	...
	public TareaFile (String nombre, String dirName, String fileName) {
		this.nombre = nombre;
